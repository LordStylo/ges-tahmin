Create Codex pet row `running-right` for `itachi`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Humanoid anime shinobi companion; preserve the supplied black cloak, long dark hair, forehead protector, pale face, red eyes, and red cloud markings.. Preserve silhouette, face, palette, material, proportions, markings, and props.
