Create one horizontal animation strip for Codex pet `itachi`, state `running-right`.
...
Identity: same pet in every frame: Humanoid anime shinobi companion; preserve the supplied black cloak, long dark hair, forehead protector, pale face, red eyes, and red cloud markings.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
